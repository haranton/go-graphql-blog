...
Описание:
Возвращает пост по его id, включая комментарии и вложенные ответы. Уровень вложенности контролирует клиент, добавляя replies в запрос. Для решения проблемы n + 1 есть механизм dataloader.
